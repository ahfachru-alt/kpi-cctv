    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      <aside className="fixed inset-y-0 left-0 w-64 bg-white/95 ring-1 ring-gray-200 p-4 flex flex-col gap-2">
        ...
        <nav className="flex flex-col gap-1 text-sm">
          <Link href={route('user.dashboard')} className="flex items-center gap-2 rounded px-3 py-2 hover:bg-gray-100"><DashboardIcon className="h-5 w-5" /> <span>Dashboard</span></Link>
          <Link href={route('user.maps')} className="flex items-center gap-2 rounded px-3 py-2 hover:bg-gray-100"><MapIcon className="h-5 w-5" /> <span>Maps</span></Link>
          <Link href={route('user.location.index')} className="flex items-center gap-2 rounded px-3 py-2 hover:bg-gray-100"><LocationIcon className="h-5 w-5" /> <span>Location</span></Link>
          <Link href={route('user.contact')} className="flex items-center gap-2 rounded px-3 py-2 hover:bg-gray-100"><ContactIcon className="h-5 w-5" /> <span>Contact</span></Link>
